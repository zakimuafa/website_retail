            ...
            <div class="col-md-12">
                <div class="box">
                    <form class="form-horizontal" id="submit" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="row space">
                                <div class="col-md-2"><label class="control-label" for="nama_agama">Agama</label></div>
                                <div class="col-md-10">
                                    <input type="text" name="nama_agama" id="nama_agama" class="form-control" required autocomplete="off">
                                </div>
                                <br/><br/>
...
$(document).ready(function(){
    ...
    $('#submit').submit(function(e){
        ...
        if(a!=b){
            ...
            e.preventDefault(); 
                $.ajax({
                    url:'<?php echo base_url();?>Masterdata/agama_create',
                    type:"post",
