                    ...
                    <form class="form-horizontal" id="submit" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="row space">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="teks_1" id="subjudul_1" class="form-control" >
                                </div>
                                 <br/><br/>
                            ...
                            <div class="row text-center">
                                <button type="submit" class="btn btn-success">Simpan</button>&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url()?>Klien/index" class="btn btn-warning">Kembali</a>
                            </div>
                        </div>
                    </form>
                </div>
